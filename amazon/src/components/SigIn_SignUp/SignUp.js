                    ...
                    <div className="sign_form">
                        <form method="POST">
                            ...
                            <div className="form_data">
                                ...
                                <input type="text" onChange={addData} value={userData.name} name='name' id='name' placeholder='Enter Your Name' />
                            </div>
                            <div className="form_data">
                            ...
                            <div className="form_data">
                                ...
                                <input type="text" onChange={addData} value={userData.phone} name='phone' id='phone' placeholder='Enter Your Phone Number' />
                            </div>
                            <div className="form_data">
